...
# Mainland China business - "all other currency conversions" public rate
# This is an estimate model, not an official account-specific PayPal quote.
...
def estimate_paypal_rate_from_market(market_rate: float, spread: float) -> float:
    # Estimated "worse than market" rate when converting into USD.
    # This is an inference model for public-data estimation only.
